...
// ===== إعدادات القنوات والرتب (عدّل القيم حسب سيرفرك) =====
const LOGS = {
...
const WELCOME_CHANNEL = "1480128982996357313"; // قناة الترحيب
const AUTO_ROLE_ID = "1480937552386064536"; // الرتبة التلقائية

const TOKEN = process.env.TOKEN; // التوكن من ملف .env
